...
// Source: internal/service/packages/base.go
//
...
import (
	context "context"
	entity "datink/internal/models/package/entity"
	reflect "reflect"
...
func (m *MockService) FindAll(ctx context.Context) ([]entity.Package, error) {
	m.ctrl.T.Helper()
